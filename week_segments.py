...
for i in week:
	...
	for j in range(0,num_segments):
		command = 'ffmpeg -i MultiCoder_SOAP_4_DCTECH-MC01X_'+i+'-2015_16-00-00.wav -acodec copy -to ' + atc_clock[j][2] + ' -ss ' + atc_clock[j][1] + ' ' +  atc_clock[j][0] + '_' + 'MultiCoder_SOAP_4_DCTECH-MC01X_'+i+'-2015_16-00-00.wav'
		print command
		c = subprocess.call(command, shell=True)
		command = 'ffmpeg -nostats -i ' + atc_clock[j][0] + '_' + 'MultiCoder_SOAP_4_DCTECH-MC01X_'+i+'-2015_16-00-00.wav -filter_complex ebur128=framelog=verbose:peak=true -f null -'
		c = subprocess.call(command, stdout=log, stderr=log, shell=True)

		command = 'ffmpeg -i MultiCoder_SOAP_1_DCTECH-MC01X_'+i+'-2015_17-00-00.wav -acodec copy -to ' + atc_clock[j][2] + ' -ss ' + atc_clock[j][1] + ' ' +  atc_clock[j][0] + '_' + 'MultiCoder_SOAP_1_DCTECH-MC01X_'+i+'-2015_17-00-00.wav'
		print command
		c = subprocess.call(command, shell=True)
		command = 'ffmpeg -nostats -i ' + atc_clock[j][0] + '_' + 'MultiCoder_SOAP_1_DCTECH-MC01X_'+i+'-2015_17-00-00.wav -filter_complex ebur128=framelog=verbose:peak=true -f null -'
		c = subprocess.call(command, stdout=log, stderr=log, shell=True)
...
for i in weekend:
	...
	for j in range(0,num_segments):
		command = 'ffmpeg -i MultiCoder_SOAP_4_DCTECH-MC01X_'+i+'-2015_08-00-00.wav -acodec copy -to ' + we_clock[j][2] + ' -ss ' + we_clock[j][1] + ' ' +  we_clock[j][0] + '_' + 'MultiCoder_SOAP_4_DCTECH-MC01X_'+i+'-2015_08-00-00.wav'
		print command
		c = subprocess.call(command, shell=True)
		command = 'ffmpeg -nostats -i ' + we_clock[j][0] + '_' + 'MultiCoder_SOAP_4_DCTECH-MC01X_'+i+'-2015_08-00-00.wav -filter_complex ebur128=framelog=verbose:peak=true -f null -'
		c = subprocess.call(command, stdout=log, stderr=log, shell=True)

		command = 'ffmpeg -i MultiCoder_SOAP_1_DCTECH-MC01X_'+i+'-2015_09-00-00.wav -acodec copy -to ' + we_clock[j][2] + ' -ss ' + we_clock[j][1] + ' ' +  we_clock[j][0] + '_' + 'MultiCoder_SOAP_1_DCTECH-MC01X_'+i+'-2015_09-00-00.wav'
		print command
		c = subprocess.call(command, shell=True)
		command = 'ffmpeg -nostats -i ' + we_clock[j][0] + '_' + 'MultiCoder_SOAP_1_DCTECH-MC01X_'+i+'-2015_09-00-00.wav -filter_complex ebur128=framelog=verbose:peak=true -f null -'
		c = subprocess.call(command, stdout=log, stderr=log, shell=True)

		command = 'ffmpeg -i MultiCoder_SOAP_4_DCTECH-MC01X_'+i+'-2015_17-00-00.wav -acodec copy -to ' + we_clock[j][2] + ' -ss ' + we_clock[j][1] + ' ' +  we_clock[j][0] + '_' + 'MultiCoder_SOAP_4_DCTECH-MC01X_'+i+'-2015_17-00-00.wav'
		print command
		c = subprocess.call(command, shell=True)
		command = 'ffmpeg -nostats -i ' + we_clock[j][0] + '_' + 'MultiCoder_SOAP_4_DCTECH-MC01X_'+i+'-2015_17-00-00.wav -filter_complex ebur128=framelog=verbose:peak=true -f null -'
		c = subprocess.call(command, stdout=log, stderr=log, shell=True)
